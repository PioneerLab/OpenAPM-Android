...
public class FinalizableReferenceQueue implements Closeable
{
    ...
    static class SystemLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            ...
            if (systemLoader != null) {
                try {
                    return systemLoader.loadClass("com.newrelic.com.google.common.base.internal.Finalizer");
                }
    ...
    static class DecoupledLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            try {
                ...
                return finalizerLoader.loadClass("com.newrelic.com.google.common.base.internal.Finalizer");
            }
            catch (Exception e) {
        ...
        URL getBaseUrl() throws IOException {
            final String finalizerPath = "com.newrelic.com.google.common.base.internal.Finalizer".replace('.', '/') + ".class";
    ...
    static class DirectLoader implements FinalizerLoader
    {
        ...
        public Class<?> loadFinalizer() {
            try {
                return Class.forName("com.newrelic.com.google.common.base.internal.Finalizer");
            }
