...
public abstract class CtBehavior extends CtMember
{
    ...
    public void useCflow(final String name) throws CannotCompileException {
        ...
        while (true) {
            ...
            try {
                ...
                try {
                    final CtClass type = pool.get("com.newrelic.javassist.runtime.Cflow");
    ...
    public void insertAfter(final String src, final boolean asFinally) throws CannotCompileException {
        ...
        try {
            ...
            jv.recordLocalVariables(ca, 0);
            final int handlerLen = this.insertAfterHandler(asFinally, b, rtype, varNo, jv, src);
            this.insertAfterAdvice(b, jv, src, pool, rtype, varNo);
            ca.setMaxStack(b.getMaxStack());
            ca.setMaxLocals(b.getMaxLocals());
            final int gapPos = iterator.append(b.get());
            iterator.append(b.getExceptionTable(), gapPos);
            if (asFinally) {
                ca.getExceptionTable().add(this.getStartPosOfBody(ca), gapPos, gapPos, 0);
            }
            final int gapLen = iterator.getCodeLength() - gapPos - handlerLen;
            ...
            while (iterator.hasNext()) {
                ...
                this.insertGoto(iterator, subr, pos);
    ...
    private void insertAfterAdvice(final Bytecode code, final Javac jv, final String src, final ConstPool cp, final CtClass rtype, final int varNo) throws CompileError {
