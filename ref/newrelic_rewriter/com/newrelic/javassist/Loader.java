...
public class Loader extends ClassLoader
{
    ...
    private void init(final ClassPool cp) {
        ...
        this.domain = null;
        this.delegateLoadingOf("com.newrelic.javassist.Loader");
    }
    ...
    public void run(final String classname, final String[] args) throws Throwable {
        ...
        try {
            c.getDeclaredMethod("main", (Loader.array$Ljava$lang$String == null) ? (Loader.array$Ljava$lang$String = class$("[Ljava.lang.String;")) : Loader.array$Ljava$lang$String).invoke(null, args);
        }
