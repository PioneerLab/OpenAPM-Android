        ...
        try {
            AccessController.doPrivileged((PrivilegedExceptionAction<Object>)new PrivilegedExceptionAction() {
                public Object run() throws Exception {
                    ...
                    ClassPool.defineClass1 = cl.getDeclaredMethod("defineClass", (ClassPool.class$java$lang$String == null) ? (ClassPool.class$java$lang$String = ClassPool.class$("java.lang.String")) : ClassPool.class$java$lang$String, (ClassPool.array$B == null) ? (ClassPool.array$B = ClassPool.class$("[B")) : ClassPool.array$B, Integer.TYPE, Integer.TYPE);
                    ClassPool.defineClass2 = cl.getDeclaredMethod("defineClass", (ClassPool.class$java$lang$String == null) ? (ClassPool.class$java$lang$String = ClassPool.class$("java.lang.String")) : ClassPool.class$java$lang$String, (ClassPool.array$B == null) ? (ClassPool.array$B = ClassPool.class$("[B")) : ClassPool.array$B, Integer.TYPE, Integer.TYPE, (ClassPool.class$java$security$ProtectionDomain == null) ? (ClassPool.class$java$security$ProtectionDomain = ClassPool.class$("java.security.ProtectionDomain")) : ClassPool.class$java$security$ProtectionDomain);
                    return null;
                }
            });
        }
