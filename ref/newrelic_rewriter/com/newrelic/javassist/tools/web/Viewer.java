...
public class Viewer extends ClassLoader
{
    ...
    public void run(final String classname, final String[] args) throws Throwable {
        ...
        try {
            c.getDeclaredMethod("main", (Viewer.array$Ljava$lang$String == null) ? (Viewer.array$Ljava$lang$String = class$("[Ljava.lang.String;")) : Viewer.array$Ljava$lang$String).invoke(null, args);
        }
    ...
    protected Class findClass(final String name) throws ClassNotFoundException {
        Class c = null;
        if (name.startsWith("java.") || name.startsWith("javax.") || name.equals("com.newrelic.javassist.tools.web.Viewer")) {
