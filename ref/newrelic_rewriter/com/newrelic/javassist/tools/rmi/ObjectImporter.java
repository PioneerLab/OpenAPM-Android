...
public class ObjectImporter implements Serializable
{
    ...
    static {
        proxyConstructorParamTypes = new Class[] { (ObjectImporter.class$javassist$tools$rmi$ObjectImporter == null) ? (ObjectImporter.class$javassist$tools$rmi$ObjectImporter = class$("com.newrelic.javassist.tools.rmi.ObjectImporter")) : ObjectImporter.class$javassist$tools$rmi$ObjectImporter, Integer.TYPE };
    }
}
