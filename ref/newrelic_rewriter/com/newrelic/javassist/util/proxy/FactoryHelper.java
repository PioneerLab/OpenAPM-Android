...
public class FactoryHelper
{
    ...
    static {
        try {
            ...
            FactoryHelper.defineClass1 = SecurityActions.getDeclaredMethod(cl, "defineClass", new Class[] { (FactoryHelper.class$java$lang$String == null) ? (FactoryHelper.class$java$lang$String = class$("java.lang.String")) : FactoryHelper.class$java$lang$String, (FactoryHelper.array$B == null) ? (FactoryHelper.array$B = class$("[B")) : FactoryHelper.array$B, Integer.TYPE, Integer.TYPE });
            FactoryHelper.defineClass2 = SecurityActions.getDeclaredMethod(cl, "defineClass", new Class[] { (FactoryHelper.class$java$lang$String == null) ? (FactoryHelper.class$java$lang$String = class$("java.lang.String")) : FactoryHelper.class$java$lang$String, (FactoryHelper.array$B == null) ? (FactoryHelper.array$B = class$("[B")) : FactoryHelper.array$B, Integer.TYPE, Integer.TYPE, (FactoryHelper.class$java$security$ProtectionDomain == null) ? (FactoryHelper.class$java$security$ProtectionDomain = class$("java.security.ProtectionDomain")) : FactoryHelper.class$java$security$ProtectionDomain });
        }
        catch (Exception e) {
