...
class SerializedProxy implements Serializable
{
    ...
    SerializedProxy(final Class proxy, final byte[] sig, final MethodHandler h) {
        ...
        final String setterInf = ((SerializedProxy.class$javassist$util$proxy$ProxyObject == null) ? (SerializedProxy.class$javassist$util$proxy$ProxyObject = class$("com.newrelic.javassist.util.proxy.ProxyObject")) : SerializedProxy.class$javassist$util$proxy$ProxyObject).getName();
        for (int i = 0; i < n; ++i) {
    ...
    Object readResolve() throws ObjectStreamException {
        try {
            ...
            final ProxyObject proxy = f.createClass(this.filterSignature).newInstance();
