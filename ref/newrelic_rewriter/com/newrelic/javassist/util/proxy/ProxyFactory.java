...
public class ProxyFactory
{
    ...
    public static boolean isProxyClass(final Class cl) {
        return ((ProxyFactory.class$javassist$util$proxy$ProxyObject == null) ? (ProxyFactory.class$javassist$util$proxy$ProxyObject = class$("com.newrelic.javassist.util.proxy.ProxyObject")) : ProxyFactory.class$javassist$util$proxy$ProxyObject).isAssignableFrom(cl);
    }
    ...
    private static void setInterfaces(final ClassFile cf, final Class[] interfaces) {
        final String setterIntf = ((ProxyFactory.class$javassist$util$proxy$ProxyObject == null) ? (ProxyFactory.class$javassist$util$proxy$ProxyObject = class$("com.newrelic.javassist.util.proxy.ProxyObject")) : ProxyFactory.class$javassist$util$proxy$ProxyObject).getName();
        String[] list;
    ...
    private static MethodInfo makeConstructor(final String thisClassName, final Constructor cons, final ConstPool cp, final Class superClass, final boolean doHandlerInit) {
        ...
        code.addAload(0);
        code.addGetstatic("com.newrelic.javassist.util.proxy.RuntimeSupport", "default_interceptor", ProxyFactory.HANDLER_TYPE);
        code.addPutfield(thisClassName, "handler", ProxyFactory.HANDLER_TYPE);
    ...
    private static MethodInfo makeForwarder(final String thisClassName, final Method meth, final String desc, final ConstPool cp, final Class declClass, final String delegatorName, final int index) {
        ...
        code.addInvokeinterface(((ProxyFactory.class$javassist$util$proxy$MethodHandler == null) ? (ProxyFactory.class$javassist$util$proxy$MethodHandler = class$("com.newrelic.javassist.util.proxy.MethodHandler")) : ProxyFactory.class$javassist$util$proxy$MethodHandler).getName(), "invoke", "(Ljava/lang/Object;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;", 5);
    ...
    private static void callFind2Methods(final Bytecode code, final String superMethod, final String thisMethod, final int index, final String desc, final int arrayVar) {
        final String findClass = ((ProxyFactory.class$javassist$util$proxy$RuntimeSupport == null) ? (ProxyFactory.class$javassist$util$proxy$RuntimeSupport = class$("com.newrelic.javassist.util.proxy.RuntimeSupport")) : ProxyFactory.class$javassist$util$proxy$RuntimeSupport).getName();
    ...
    private static MethodInfo makeWriteReplace(final ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("com.newrelic.javassist.util.proxy.RuntimeSupport", "makeSerializedProxy", "(Ljava/lang/Object;)Ljavassist/util/proxy/SerializedProxy;");
        code.addOpcode(176);
        minfo.setCodeAttribute(code.toCodeAttribute());
        return minfo;
    }
    ...
    static {
        OBJECT_TYPE = ((ProxyFactory.class$java$lang$Object == null) ? (ProxyFactory.class$java$lang$Object = class$("java.lang.Object")) : ProxyFactory.class$java$lang$Object);
        HANDLER_TYPE = 'L' + ((ProxyFactory.class$javassist$util$proxy$MethodHandler == null) ? (ProxyFactory.class$javassist$util$proxy$MethodHandler = class$("com.newrelic.javassist.util.proxy.MethodHandler")) : ProxyFactory.class$javassist$util$proxy$MethodHandler).getName().replace('.', '/') + ';';
