...
public class HotSwapper
{
    ...
    static /* synthetic */ Class class$javassist$util$Trigger;
    ...
    static {
        TRIGGER_NAME = ((HotSwapper.class$javassist$util$Trigger == null) ? (HotSwapper.class$javassist$util$Trigger = class$("com.newrelic.javassist.util.Trigger")) : HotSwapper.class$javassist$util$Trigger).getName();
    }
}
