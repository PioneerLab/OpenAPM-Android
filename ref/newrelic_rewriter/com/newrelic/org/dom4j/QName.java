    ...
    static {
        ...
        try {
            ...
            try {
                ...
                singletonClass = System.getProperty("com.newrelic.org.dom4j.QName.singleton.strategy", singletonClass);
            ...
            (QName.singleton = clazz.newInstance()).setSingletonClassName(((QName.class$org$dom4j$tree$QNameCache == null) ? (QName.class$org$dom4j$tree$QNameCache = class$("com.newrelic.org.dom4j.tree.QNameCache")) : QName.class$org$dom4j$tree$QNameCache).getName());
        }
        catch (Exception ex2) {}
    }
}
